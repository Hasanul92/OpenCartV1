...
def pytest_addoption(parser):                        # this will take the command line argument from command prompt (CLI)
    parser.addoption("--browser")

@pytest.fixture()                                    # this will send/return the value of the parameter to setup method
def browser(request):
    return request.config.getoption("--browser")
